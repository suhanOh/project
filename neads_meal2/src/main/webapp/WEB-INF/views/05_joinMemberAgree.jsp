                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="05_login.do"><button class="btn hvr-hover" type="button" style="width: 115px; color:white; font-size: small;">이전 단계</button>
    							</a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="05_joinMemberForm.do"><button class="btn hvr-hover" type="button" style="width: 115px; color:white; font-size: small; background-color:rgba(23, 45, 15, 0.848);">다음 단계</button>
                            	</a>
                            </div>
                        </div>
                    </form>
