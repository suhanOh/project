...
<title>Insert title here</title>
    <link rel="stylesheet" href="./css/material_addition_edition_deletion.css">
</head>
   ...
   <section class="page_core">
        ...
        <div class="area_left">
            ...
            <div class="page_element_middle">
                <div class="row_first">
                    <input class="btn_material_code btn_mealkit_name dark_grey_btn" type="text" placeholder="재료코드" name="미정된_사항"></input>
                    
                </div>
                <div class="row_second">
                    <input class="btn_category dark_grey_btn" type="text" placeholder="카테고리"
                        name="미정된_사항"></input>
                </div>
                <div class="row_third">
                    <input class="btn_material_name dark_grey_btn" type="text" placeholder="재료명"
                        name="미정된_사항"></input>
                </div>
                <div class="row_forth">
                    <input class="btn_weight dark_grey_btn" type="text" placeholder="무게"
                        name="미정된_사항"></input>
                </div>
                <div class="row_sixth">
        ...
        <div class="area_right">
            ...
            <table>
                ...
                <tr>
                    ...
                    <th class="table_head th_">무게(g)</th>
                    
                    <th class="table_head th_">재고수량</th>
                    <th class="table_head th_">가격(원)</th>
            ...
            <img class="img_buttom_right" src="./img/img_right_bottom.PNG">
        </div>
    </section>
